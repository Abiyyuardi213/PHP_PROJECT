...
class modelBarang {
    ...
    public function addBarang($barang_name, $barang_stock, $barang_supplier, $barang_status) {
        ...
        $brg = new Barang($newIdBarang, $barang_name, $barang_stock, $barang_supplier, $barang_status, $create_at);
        $this->barangs[] = $brg;
        $this->saveToSession();
    }
    ...
    public function updateBarang($barang_id, $barang_name, $barang_stock, $barang_supplier, $barang_status) {
        foreach ($this->barangs as $barang) {
